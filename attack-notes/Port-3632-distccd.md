...
FieldValueTargetMetasploitable 2 (192.168.75.130)Servicedistccd (Distributed Compiler Daemon)CVECVE-2004-2687CVSSv29.3 (High)Disclosure2002-02-01Privilege gaineddaemon (uid=1, gid=1) — not rootExploit pathUnauthenticated remote command execution
...
Recon/confirmation — nmap -p 3632 <target> --script distcc-cve2004-2687 -oA distcc_confirm
...
Second proof-of-exploit — re-ran with explicit arg:
...
Interactive shell — exploit/unix/misc/distcc_exec (rank: excellent).
...
Privilege check — confirmed daemon user, consistent with steps 1–2.
...
Sigma: DistCC Exploitation via Flow Anomaly
Sigma: Repeated Outbound Beaconing to Attacker Port
